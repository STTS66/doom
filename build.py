...
<body>
    <div id="startMenu">
        ...
        <div id="lobbyPanel">
            ...
            <div id="inviteBox" style="display: none;">
                <p style="color: #aaa; font-size: 14px; margin-bottom: 10px;" id="inviteTextDesc">Пригласи друга:</p>
    ...
    if(urlParams.get('room')) {
        ...
        targetRoomID = 'ARENA_' + Math.random().toString(36).substring(2, 7).toUpperCase();
        isGuest = false;
    }
    ...
    function initMultiplayer() {
        ...
        // Правильное переопределение методов Photon JS SDK
        ...
        photon.onActorJoin = function(actor) {
            updatePlayerListUI();
        };

        photon.onActorLeave = function(actor) {
